...
void _playlistSerialize(
  ...
  writer.writeString(offsets[0], object.customCoverPath);
...
Playlist _playlistDeserialize(
  ...
  object.customCoverPath = reader.readStringOrNull(offsets[0]);
...
extension PlaylistQueryFilter
  ...
  QueryBuilder<Playlist, Playlist, QAfterFilterCondition> isDefaultEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension PlaylistQuerySortBy on QueryBuilder<Playlist, Playlist, QSortBy> {
  QueryBuilder<Playlist, Playlist, QAfterSortBy> sortByCustomCoverPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'customCoverPath', Sort.asc);
    });
  }

  QueryBuilder<Playlist, Playlist, QAfterSortBy> sortByCustomCoverPathDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Playlist, Playlist, QAfterSortBy> sortByIsDefault() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.asc);
    });
  }

  QueryBuilder<Playlist, Playlist, QAfterSortBy> sortByIsDefaultDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistQuerySortThenBy
  ...
  QueryBuilder<Playlist, Playlist, QAfterSortBy> thenByCustomCoverPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'customCoverPath', Sort.asc);
    });
  }

  QueryBuilder<Playlist, Playlist, QAfterSortBy> thenByCustomCoverPathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'customCoverPath', Sort.desc);
    });
  }
  ...
  QueryBuilder<Playlist, Playlist, QAfterSortBy> thenByIsDefault() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.asc);
    });
  }

  QueryBuilder<Playlist, Playlist, QAfterSortBy> thenByIsDefaultDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDefault', Sort.desc);
    });
  }
...
extension PlaylistQueryWhereDistinct
  ...
  QueryBuilder<Playlist, Playlist, QDistinct> distinctByCustomCoverPath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'customCoverPath',
          caseSensitive: caseSensitive);
    });
  }
  ...
  QueryBuilder<Playlist, Playlist, QDistinct> distinctByIsDefault() {
    return QueryBuilder.apply(this, (query) {
...
extension PlaylistQueryProperty
  ...
  QueryBuilder<Playlist, String?, QQueryOperations> customCoverPathProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Playlist, bool, QQueryOperations> isDefaultProperty() {
    return QueryBuilder.apply(this, (query) {
