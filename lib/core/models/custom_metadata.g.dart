...
const CustomMetadataSchema = Schema(
  name: r'CustomMetadata',
  id: 7787860467099979947,
  properties: {
  ...
  estimateSize: _customMetadataEstimateSize,
  serialize: _customMetadataSerialize,
  deserialize: _customMetadataDeserialize,
  deserializeProp: _customMetadataDeserializeProp,
);

int _customMetadataEstimateSize(
...
CustomMetadata _customMetadataDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
  ...
  object.customCoverPath = reader.readStringOrNull(offsets[2]);
  object.genre = reader.readStringOrNull(offsets[3]);
  object.isEdited = reader.readBool(offsets[4]);
  object.title = reader.readStringOrNull(offsets[5]);
  return object;
}

P _customMetadataDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension CustomMetadataQueryFilter
    on QueryBuilder<CustomMetadata, CustomMetadata, QFilterCondition> {
  QueryBuilder<CustomMetadata, CustomMetadata, QAfterFilterCondition>
      albumIsNull() {
...
extension CustomMetadataQueryObject
    on QueryBuilder<CustomMetadata, CustomMetadata, QFilterCondition> {}
